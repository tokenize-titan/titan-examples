...
xargs -I{} echo {}@validator-bob:26656; docker run --rm -i -v ./nodes/carol:/root/.titan titand:latest tendermint show-node-id | \
...
xargs -I{} echo {}@validator-alice:26656; docker run --rm -i -v ./nodes/carol:/root/.titan titand:latest tendermint show-node-id | \
...
(docker run --rm -i -v ./nodes/alice:/root/.titan titand:latest tendermint show-node-id | \
xargs -I{} echo {}@validator-alice:26656; docker run --rm -i -v ./nodes/bob:/root/.titan titand:latest tendermint show-node-id | \
